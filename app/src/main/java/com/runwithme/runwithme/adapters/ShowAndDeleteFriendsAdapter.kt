...
class ShowAndDeleteFriendsAdapter(
    ...
    private var onClickListener: ShowAndDeleteFriendsAdapter.OnClickListener? = null
    ...
    override fun onBindViewHolder(holder: ShowAndDeleteFriendsAdapter.MyViewHolder, position: Int) {
